...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mLoadingContentErrorTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadingContentErrorTextView = (TextView) findViewById(R.id.tv_loading_content_error);
